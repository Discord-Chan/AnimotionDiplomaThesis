...
\newacronym{cli}{CLI}{A command-line interface is a method of
interacting with a computer program or operating system by typing text
commands in a terminal or console, as opposed to using a graphical user
interface that relies on icons, menus, and windows. The CLI allows users
to execute various system-level tasks and commands by entering specific
text-based commands, which are interpreted and executed by the computer.}
